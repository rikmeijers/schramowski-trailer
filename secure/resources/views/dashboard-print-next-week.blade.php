...
@section('customStyles')
    <style>
        /* Druckfreundlich: kein Header/Footer, keine Tabelle, sondern Blöcke */
        @media print {
...
@section('content')
    <div class="print-page">
        <div class="d-flex align-items-center justify-content-between gap-2 mb-3 no-print print-header">
            <div>
                <h1 class="fw-bold mb-1">Druckübersicht nächste Woche</h1>
                <div class="text-body-secondary">
                    {{ $start->format('d-m-Y') }} – {{ $endInclusive->format('d-m-Y') }}
                </div>
            </div>
        ...
        @empty
            <div class="alert alert-info border-0 shadow-sm rounded-4">
                Keine Reservierungen für nächste Woche.
            </div>
        @endforelse
    </div>
@endsection
